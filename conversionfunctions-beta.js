...
function convert0x2Char ( str ) { 
    ...
    // change 0x to ßß to avoid things like 0x1F4680x200D as being interpreted as too big a number
    str = str.replace(/0x/g,'ßß')
	
	// convert up to 6 digit escapes to characters
	str = str.replace(/ßß([A-Fa-f0-9]{1,6})/g, 
					function(matchstr, parens) {
						return hex2char(parens)
						}
						)
